<div class="card shadow-sm">
    <div class="card-body">
        <div class="row gy-2 gx-3">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <label for="fotocopy_buku_rekening" class="form-label">Fotocopy Buku Rekening Desa</label>
                    <div>
                        <input type="file" class="form-control @error('fotocopy_buku_rekening') is-invalid @enderror"
                            id="fotocopy_buku_rekening" name="fotocopy_buku_rekening">
                    </div>
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
                    <label for="laporan_realisasi_dd" class="form-label">Laporan Realisasi DD T.A {{ now()->year-1
                        }}</label>
                    <div>
                        <input type="file" class="form-control @error('laporan_realisasi_dd') is-invalid @enderror"
                            id="laporan_realisasi_dd" name="laporan_realisasi_dd">
                    </div>
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
                    <label for="desain_gambar_rab_teknis" class="form-label">Desain Gambaran dan RAB Teknis Keg.
                        Fisik</label>
                    <div>
                        <input type="file" class="form-control @error('desain_gambar_rab_teknis') is-invalid @enderror"
                            id="desain_gambar_rab_teknis" name="desain_gambar_rab_teknis">
                    </div>
                </div>
            </div>
        </div>
        <div class="form-footer mt-3">
            ...
            @endif
            <a class="btn btn-secondary col-12" href="{{ route('ppdd1.index') }}">
                Kembali
            </a>
        </div>
    </div>
