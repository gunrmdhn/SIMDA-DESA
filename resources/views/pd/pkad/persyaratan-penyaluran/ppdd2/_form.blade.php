<div class="card shadow-sm">
    <div class="card-body">
        <div class="row gy-2 gx-3">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <label for="lorpdd3" class="form-label">Laporan Output Realisasi Penyerapan Dana
                        Desa Tahap III Tahun {{ now()->year - 1 }}</label>
                    <div>
                        <input type="file" class="form-control @error('lorpdd3') is-invalid @enderror" id="lorpdd3"
                            name="lorpdd3">
                    </div>
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
                    <label for="lorpdd1" class="form-label">Laporan Output Realisasi Penyerapan Dana
                        Desa Tahap I Tahun {{ now()->year }}</label>
                    <div>
                        <input type="file" class="form-control @error('lorpdd1') is-invalid @enderror" id="lorpdd1"
                            name="lorpdd1">
                    </div>
                </div>
            </div>
        ...
        <div class="form-footer mt-3">
            ...
            @endif
            <a class="btn btn-secondary col-12" href="{{ route('ppdd2.index') }}">
                Kembali
            </a>
        </div>
    </div>
