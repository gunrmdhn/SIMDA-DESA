<div class="card shadow-sm">
    <div class="card-body">
        <div class="row gy-2 gx-3">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <label for="surat_permohonan_penyaluran" class="form-label">Surat
                        Permohonan Penyaluran Bulan Maret/Juni</label>
                    <div>
                        <input type="file"
            ...
            <div class="col-md-12">
                <div class="form-group">
                    <label for="laporan_pembayaran" class="form-label">Laporan Pembayaran BLT Tahap 1</label>
                    <div>
        ...
        <div class="form-footer mt-3">
            ...
            @endif
            <a class="btn btn-secondary col-12" href="{{ route('ppblt2.index') }}">
                Kembali
            </a>
        </div>
    </div>
